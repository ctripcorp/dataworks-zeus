...
public class StringUtil {
    ...
    /*  1. null                                                                     */
    /*  2. empty - ""                                                               */
    /*  3. blank - "全部是空白" - 空白由isWhitespace所定义。              */
    /* ============================================================================ */
     ...
     * 
     * <p>
     * 注意，和<code>String.trim</code>不同，此方法使用<code>isWhitespace</code>来判定空白，
    ...
    private static String trim(String str, String stripChars, int mode) {
        ...
        if (mode >= 0) {
            if (stripChars == null) {
                while ((start < end) && (isWhitespace(str.charAt(end - 1)))) {
                    end--;
                }
            } else if (stripChars.length() == 0) {
                return str;
    ...
    /**
     * 删除所有在<code>isWhitespace(char)</code>中所定义的空白。
     * <pre>
